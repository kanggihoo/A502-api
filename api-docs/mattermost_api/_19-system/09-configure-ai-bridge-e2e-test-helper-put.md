# 09-Configure AI bridge E2E test helper [PUT]
...
```json
{
  ...
  "agent_completions": {}, // Queued mocked completion responses keyed by explicit bridge operation name
  "feature_flags": {
  ...
  "record_requests": boolean, // Whether bridge requests should be recorded for later inspection
}
```
### Responses
