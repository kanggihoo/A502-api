# 02-Create a new playbook run [POST]
...
```json
{
  "name": string (required), // The name of the playbook run.
  "summary": string, // The summary of the playbook run.
  "owner_user_id": string (required), // The identifier of the user who is commanding the playbook run.
  "team_id": string (required), // The identifier of the team where the playbook run's channel is in.
  ...
  "playbook_id": string (required), // The identifier of the playbook with from which this playbook run was created.
}
```
### Responses
