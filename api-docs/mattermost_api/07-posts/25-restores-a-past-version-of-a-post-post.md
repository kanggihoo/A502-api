# 25-Restores a past version of a post [POST]
...
| --- | --- | --- | --- | --- |
| `post_id` | `string` | `path` | Yes | The identifier of the post to restore |
| `restore_version_id` | `string` | `path` | Yes | The identifier of the past version of post to restore to |
