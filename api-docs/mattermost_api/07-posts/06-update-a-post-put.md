...
| --- | --- | --- | --- | --- |
| `post_id` | `string` | `path` | Yes | ID of the post to update |
...
```json
{
  ...
  "is_pinned": boolean, // Set to `true` to pin the post to the channel it is in
  "message": string, // The message text of the post
  "has_reactions": boolean, // Set to `true` if the post has reactions to it
