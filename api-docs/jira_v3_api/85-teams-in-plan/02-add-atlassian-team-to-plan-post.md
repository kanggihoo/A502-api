# 02-Add Atlassian team to plan [POST]
...
```json
{
  ...
  "id": string (required), // The Atlassian team ID.
  "issueSourceId": integer, // The ID of the issue source for the Atlassian team.
  "planningStyle": enum("Scrum" | "Kanban") (required), // The planning style for the Atlassian team. This must be "Scrum" or "Kanban".
