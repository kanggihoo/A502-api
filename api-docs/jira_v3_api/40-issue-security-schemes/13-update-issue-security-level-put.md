# 13-Update issue security level [PUT]
...
| --- | --- | --- | --- | --- |
| `schemeId` | `string` | `path` | Yes | The ID of the issue security scheme level belongs to. |
| `levelId` | `string` | `path` | Yes | The ID of the issue security level to update. |
