# 16-Validate update workflows [POST]
    ...
    "workflows": [
      {
        "defaultStatusMappings": [
          {
            "newStatusReference": string (required), // The new status ID.
            "oldStatusReference": string (required), // The old status ID.
          }
        ], // The mapping of old to new status ID.
        "description": string, // The new description for this workflow.
        "id": string (required), // The ID of this workflow.
        ...
        "statusMappings": [
          {
            "issueTypeId": string (required), // The issue type for the status mapping.
            "projectId": string (required), // The project for the status mapping.
            "statusMigrations": [
              {
                "newStatusReference": string (required), // The new status ID.
                "oldStatusReference": string (required), // The old status ID.
              }
            ] (required), // The list of old and new status ID mappings for the specified project and issue type.
          }
