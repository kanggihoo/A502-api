# 07-Get workflow schemes which are using a given workflow [GET]
...
```json
"{\"workflowId\":\"fb759d53-a3a4-45ff-9de4-547c4b638dde\",\"workflowSchemes\":{\"nextPageToken\":\"eyJvIjoyfQ==\",\"values\":[{\"id\":\"1000\"}]}}"
```
