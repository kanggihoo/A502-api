...
```json
{
  "note": string (required), // The content of a note.
  "in_reply_to_discussion_id": string, // The ID of a discussion the draft note replies to.
  "commit_id": string, // The sha of a commit to associate the draft note to.
  "resolve_discussion": boolean, // The associated discussion should be resolved.
  "position": {
