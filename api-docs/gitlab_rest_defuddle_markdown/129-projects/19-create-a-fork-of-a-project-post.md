...
```json
{
  "namespace": string, // (deprecated) The ID or name of the namespace that the project will be forked into
  "namespace_id": integer, // The ID of the namespace that the project will be forked into
  "namespace_path": string, // The path of the namespace that the project will be forked into
  "path": string, // The path that will be assigned to the fork
  "name": string, // The name that will be assigned to the fork
  "description": string, // The description that will be assigned to the fork
  "visibility": enum("private" | "internal" | "public"), // The visibility of the fork
