# 139-Create/Edit Matrix integration [PUT]
...
```json
{
  ...
  "token": string (required), // The Matrix access token (for example, `syt-zyx57W2v1u123ew11`).
  "room": string (required), // Unique identifier for the target room (in the format `!qPKKM111FFKKsfoCVy:matrix.org`).
