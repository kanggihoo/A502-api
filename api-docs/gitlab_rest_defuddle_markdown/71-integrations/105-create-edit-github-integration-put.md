# 105-Create/Edit Github integration [PUT]
...
```json
{
  "token": string (required), // GitHub API token with `repo:status` OAuth scope.
  "repository_url": string (required), // GitHub repository URL.
  "static_context": boolean, // Append the hostname of your GitLab instance to the status check name.
