# 162-Create/Edit Google Cloud Platform Artifact Registry integration [PUT]
...
```json
{
  "artifact_registry_project_id": string (required), // ID of the Google Cloud project.
  "artifact_registry_repositories": string (required), // Repository of Artifact Registry.
  "artifact_registry_location": string (required), // Location of the Artifact Registry repository.
