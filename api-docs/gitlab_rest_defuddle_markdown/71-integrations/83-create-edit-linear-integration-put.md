# 83-Create/Edit Linear integration [PUT]

`PUT /api/v4/projects/{id}/integrations/linear`
...
```json
{
  "workspace_url": string (required), // Linear workspace URL (for example, https://linear.app/example)
