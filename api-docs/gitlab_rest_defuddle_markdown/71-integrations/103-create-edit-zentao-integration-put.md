# 103-Create/Edit Zentao integration [PUT]
...
```json
{
  "url": string (required), // Base URL of the ZenTao instance.
  "api_url": string, // If different from Web URL.
  "api_token": string (required),
  "zentao_product_xid": string (required),
