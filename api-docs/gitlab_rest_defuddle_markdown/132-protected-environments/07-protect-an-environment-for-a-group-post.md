# 07-Protect an environment for a group [POST]
...
```json
{
  "name": string (required), // The deployment tier of the protected environment. One of `production`, `staging`, `testing`, `development`, or `other`
