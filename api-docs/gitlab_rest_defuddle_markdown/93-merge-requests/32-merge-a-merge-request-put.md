...
```json
{
  ...
  "should_remove_source_branch": boolean, // If `true`, removes the source branch.
  "merge_when_pipeline_succeeds": boolean, // Deprecated: Use auto_merge instead.
  "auto_merge": boolean, // If `true`, the merge request is set to auto merge.
  ...
  "skip_merge_train": boolean, // If `true` skips train restart when merging immediately in a merge train configured project.
}
```
### Responses
