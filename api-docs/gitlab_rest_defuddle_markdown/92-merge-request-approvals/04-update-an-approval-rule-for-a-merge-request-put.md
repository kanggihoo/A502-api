# 04-Update an approval rule for a merge request [PUT]

`PUT /api/v4/projects/{id}/merge_requests/{merge_request_iid}/approval_rules/{approval_rule_id}`
...
```json
{
  ...
  "remove_hidden_groups": boolean, // Whether hidden groups should be removed
}
```
### Responses
