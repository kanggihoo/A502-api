# 123-Create/Edit Custom Issue Tracker integration [PUT]
...
```json
{
  "project_url": string (required), // URL of the project.
  "issues_url": string (required), // URL of the issue.
  "new_issue_url": string (required), // URL of the new issue.
