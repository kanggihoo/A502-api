# 03-Create a related epic link [POST]
...
```json
{
  "target_group_id": string (required), // ID or URL-encoded path of the target group
  "target_epic_iid": integer (required), // Internal ID of a target group's epic
  "link_type": enum("relates_to" | "blocks" | "is_blocked_by"), // The type of the relation
}
```
### Responses
