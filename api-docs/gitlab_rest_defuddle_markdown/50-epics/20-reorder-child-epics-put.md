...
```json
{
  "move_before_id": integer, // The ID of the epic that should be positioned before the child epic
  "move_after_id": integer, // The ID of the epic that should be positioned after the child epic
}
```
### Responses
