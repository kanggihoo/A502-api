# 21-Update a related epic link [PUT]
...
| `epic_issue_id` | `any` | `path` | Yes | The ID of the epic-issue association to update |
...
```json
{
  ...
  "epic_issue_id": integer, // ID of the epic-issue relation
