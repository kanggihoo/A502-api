# 02-Update global notification level settings and email, defaults to Participate [PUT]

`PUT /api/v4/notification_settings`
...
```json
{
  ...
  "approver": boolean, // Enable/disable this notification
}
```
### Responses
