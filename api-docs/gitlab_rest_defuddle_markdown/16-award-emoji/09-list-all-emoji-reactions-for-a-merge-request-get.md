# 09-List all emoji reactions for a merge request [GET]
...
| `merge_request_iid` | `integer` | `path` | Yes | ID (`iid` for merge requests/issues/epics, `id` for snippets) of an awardable. |
