...
| `search` | `string` | `query` | No | Return list of authorized projects matching the search criteria |
| `order_by` | `string` | `query` | No | Return projects ordered by field |
...
| `with_shared` | `boolean` | `query` | No | Include projects shared to this group |
| `include_subgroups` | `boolean` | `query` | No | Includes projects in subgroups of this group |
| `include_ancestor_groups` | `boolean` | `query` | No | Includes projects in ancestors of this group |
| `min_access_level` | `integer` | `query` | No | Limit by minimum access level of authenticated user on projects |
...
| `with_security_reports` | `boolean` | `query` | No | Return only projects having security report artifacts present |
