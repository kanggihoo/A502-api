...
```json
{
  ...
  "assignee_id": integer, // The ID of a user to associate with board
  "milestone_id": integer, // The ID of a milestone to associate with board
  "labels": string, // Comma-separated list of label names
  "weight": integer, // The weight of the board
}
```
### Responses
